    ...
    return (
        <>
            ...
            <section id="our-team" className="container my-5">
                ...
                <div className="row">
                    <div className="col-md-4 text-center mb-4">
                        <img src="P.jpeg" alt="Team Member 1" className="rounded-circle mb-3 mx-auto" style={{ maxWidth: '200px' }} />
                    ...
                    <div className="col-md-4 text-center mb-4">
                        <img src="A.jpeg" alt="Team Member 2" className="img-fluid rounded-circle mb-3 mx-auto" style={{ maxWidth: '200px' }} />
                        <h3>B Abhiram</h3>
                        <p>CTO & Co-Founder</p>
                    ...
                    <div className="col-md-4 text-center mb-4">
                        <img src="S.jpeg" alt="Team Member 3" className="img-fluid rounded-circle mb-3 mx-auto" style={{ maxWidth: '200px' }} />
            ...
            <section id="contact" className="container text-center my-5">
                ...
                <p>
                    <a href="https://www.facebook.com/Freepik" target="_blank" className="btn btn-primary mx-2">Facebook</a>
                    <a href="https://www.instagram.com/__s_h_e_l_l_u__/?igsh=YzljYTk1ODg3Zg%3D%3D#" target="_red" className="btn btn-primary mx-2">Instagram</a>
                    <a href="https://in.linkedin.com/in/shellu-k-shaji-694a1a294" target="_blank" className="btn btn-primary mx-2">Linkedin</a>
                </p>
            </section>
            ...
            <section id="map" className="container my-5">
                ...
                <div className="text-center">
                    <img src="https://maps.googleapis.com/maps/api/staticmap?center=9.588026,76.577150&zoom=15&size=600x400&markers=color:red%7Clabel:S%7C9.588026,76.577150&key=YOUR_GOOGLE_MAPS_API_KEY" alt="Zarcuit Location Map" className="img-fluid mx-auto" />
                </div>
            </section>
